...
oneinstack 新上的图好清楚
![intall](https://static.oneinstack.com/images/install_oneinstack.png)

装好之后建议马上安装附加组件里的 let's encrypt 的客户端，这样建站时就会自动申请并绑定 SSL 证书了。

`./addons.sh`
![addon](https://static.oneinstack.com/images/addons.png)

下面添加虚拟主机

`./vhost.sh`
![addhost](https://static.oneinstack.com/images/vhost.png)
...
3306 端口开放给自己的 RDS，CIDR 复制进去就好了，够安全，联通也不会有问题。
