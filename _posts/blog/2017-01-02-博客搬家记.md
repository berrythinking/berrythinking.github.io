...
![mzlogin](https://i349.photobucket.com/albums/q365/Athen_Ai/blog/mzlogin.png)在此之前比较钟情 jacman 的模板![jacman](https://i349.photobucket.com/albums/q365/Athen_Ai/blog/jacman.png)，看到码志的更符合我的审美，于是我就直接 folk 过来了，然后放在了 berrythinking.github.io 的主分支下。
...
本文图片及链接待我有空再上传，先挖个坑。哦，对了，还有 cloudflare 的 SSL。
